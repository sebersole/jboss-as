...
public enum TopElement {
   ...
   private static final Map<String, TopElement> MAP;

   static {
      final Map<String, TopElement> map = new HashMap<String, TopElement>();
      for (TopElement element : values()) {
   ...
   public static TopElement forName(String localName) {
      final TopElement element = MAP.get(localName);
