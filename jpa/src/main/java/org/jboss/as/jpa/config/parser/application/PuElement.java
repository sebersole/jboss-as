...
public enum PuElement {
   ...
   private static final Map<String, PuElement> MAP;

   static {
      final Map<String, PuElement> map = new HashMap<String, PuElement>();
      for (PuElement element : values()) {
   ...
   public static PuElement forName(String localName) {
      final PuElement element = MAP.get(localName);
